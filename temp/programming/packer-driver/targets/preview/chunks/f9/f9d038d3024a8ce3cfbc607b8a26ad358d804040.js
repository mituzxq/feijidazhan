    ...
    execute: function () {
      ...
      _export("Missile", Missile = (_dec = ccclass('Missile'), _dec(_class = class Missile extends Component {
        ...
        update(deltaTime) {
          ...
          var enemy = this.node.parent.getChildByName("enemy").getComponent(_crd && Enemy === void 0 ? (_reportPossibleCrUseOfEnemy({
            error: Error()
...
//# sourceMappingURL=f9d038d3024a8ce3cfbc607b8a26ad358d804040.js.map