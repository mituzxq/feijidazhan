      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        ememy() {
          this.schedule(() => {
            ...
            enemy.setPosition(ememyX, 550, 0); // let enemypos = enemy.position;
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          if (selfCollider.tag == 1 && otherCollider.tag == 2 || selfCollider.tag == 2 && otherCollider.tag == 1) {
            ...
            this.node.parent.getChildByName("EnemyAll").getChildByName("enemy").destroy(); // this.score();
          }
...
//# sourceMappingURL=390b684574e8ad7c525a5267e68814156b70d484.js.map