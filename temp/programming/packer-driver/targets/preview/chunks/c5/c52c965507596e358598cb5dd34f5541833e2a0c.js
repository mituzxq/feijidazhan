      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        Bullets() {
          this.schedule(() => {
            ...
            var play = new (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              error: Error()
            }), Player) : Player)();
            var player = play.node.position; // let player = this.node.parent.position;
...
//# sourceMappingURL=c52c965507596e358598cb5dd34f5541833e2a0c.js.map