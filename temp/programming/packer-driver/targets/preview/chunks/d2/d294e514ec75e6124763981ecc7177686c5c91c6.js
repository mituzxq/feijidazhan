      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        start() {
          this.schedule(() => {
            ...
            var player = this.node.parent.getChildByName("hero");
            console.log(player.name); // buller.setPosition(player.x, player.y + 40, 0);
          }, 0.5); // this.schedule(() => {
...
//# sourceMappingURL=d294e514ec75e6124763981ecc7177686c5c91c6.js.map