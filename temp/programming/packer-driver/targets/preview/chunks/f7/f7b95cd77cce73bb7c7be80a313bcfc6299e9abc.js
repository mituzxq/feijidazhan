  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        Bullets() {
          this.schedule(() => {
            var buller = instantiate(this.bullerPre); // let player = this.getComponent(Player).node.position;
            // let play = new Player();
...
//# sourceMappingURL=f7b95cd77cce73bb7c7be80a313bcfc6299e9abc.js.map