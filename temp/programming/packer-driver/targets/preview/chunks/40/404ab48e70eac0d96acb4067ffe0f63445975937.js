      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          if (selfCollider.tag == 1 && otherCollider.tag == 2 || selfCollider.tag == 2 && otherCollider.tag == 1) {
            ...
            var t = this.node.parent.getChildByName("EnemyAll");
            t.getChildByName("enemybullet").getComponent(_crd && EnemyBullet === void 0 ? (_reportPossibleCrUseOfEnemyBullet({
              error: Error()
            }), EnemyBullet) : EnemyBullet).die(); // this.score();
...
//# sourceMappingURL=404ab48e70eac0d96acb4067ffe0f63445975937.js.map