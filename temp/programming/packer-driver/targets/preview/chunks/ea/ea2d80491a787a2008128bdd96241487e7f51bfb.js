      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        ememybullet() {
          this.schedule(() => {
            ...
            var EnemyAll = this.node.parent.getChildByName("EnemyAll");
            var enemys = EnemyAll.getChildByName("enemy");
            var enemy = enemys.position;
...
//# sourceMappingURL=ea2d80491a787a2008128bdd96241487e7f51bfb.js.map