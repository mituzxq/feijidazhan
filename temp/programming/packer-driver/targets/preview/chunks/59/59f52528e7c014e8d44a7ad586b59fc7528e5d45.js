          ...
          if (selfCollider.tag == 1 && otherCollider.tag == 2 || selfCollider.tag == 2 && otherCollider.tag == 1) {
            if (selfCollider.tag == 1) {
              selfCollider.getComponent(_crd && PlayerBullet === void 0 ? (_reportPossibleCrUseOfPlayerBullet({
                error: Error()
              }), PlayerBullet) : PlayerBullet).die(); // otherCollider.getComponent(Enemy).die();
            ...
            if (selfCollider.tag == 2) {
              selfCollider.getComponent(_crd && Enemy === void 0 ? (_reportPossibleCrUseOfEnemy({
                error: Error()
              }), Enemy) : Enemy).die(); // otherCollider.getComponent(PlayerBullet).die();
              // this.node.parent.getChildByName("EnemyAll").getChildByName("enemybullet").getComponent(EnemyBullet).die();
            }

            this.node.parent.getChildByPath("EnemyAll/enemy").destroy();
            this.node.parent.getChildByPath("EnemyAll/enemybullet").destroy(); // this.score();
          }
...
//# sourceMappingURL=59f52528e7c014e8d44a7ad586b59fc7528e5d45.js.map