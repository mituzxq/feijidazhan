System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Contact2DType, PhysicsSystem2D, Label, director, BoxCollider2D, Enemy, Enemy1, EnemyBullet, EnemyBullet1, GameManger, Missile, PlayerBullet, _dec, _class, _crd, ccclass, Collider;
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (selfCollider.tag == 1 && otherCollider.tag == 6 || selfCollider.tag == 6 && otherCollider.tag == 1) {
            if (selfCollider.tag == 1) {
              selfCollider.getComponent(_crd && PlayerBullet === void 0 ? (_reportPossibleCrUseOfPlayerBullet({
                error: Error()
              }), PlayerBullet) : PlayerBullet).die(); // otherCollider.getComponent(Enemy1).die();

              this.count++;
            }

            if (selfCollider.tag == 6) {
              this.count++; // selfCollider.getComponent(Enemy1).die();
...
//# sourceMappingURL=c1607f09ce693597c37b53210b2562ad82cab6ab.js.map