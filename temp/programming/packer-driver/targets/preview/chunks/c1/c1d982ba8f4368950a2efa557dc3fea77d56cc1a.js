      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        bulleris() {
          switch (this.randomss) {
            case 0:
              ...
              this.istrue = true;
              break;
            // case 1: this.playerbullet3(); this.istrue = true; break;
          }
        } //单颗子弹
        ...
        playerbullet2() {
          this.schedule(() => {
            ...
            var player = this.node.parent.getChildByName("hero").position;
            buller.setPosition(player.x, player.y + 50, 0); // buller2.setPosition(player.x - 20, player.y + 50, 0);
        ...
        playerbullet3() {
          this.schedule(() => {
            ...
            buller.setParent(this.node.parent);
            buller2.setParent(this.node.parent);
            var player = this.node.parent.getChildByName("hero").position; // buller.setPosition(player.x, player.y + 50, 0);

            buller2.setPosition(player.x - 40, player.y, 0);
          }, 0.5, 10);
        }
...
//# sourceMappingURL=c1d982ba8f4368950a2efa557dc3fea77d56cc1a.js.map