System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Contact2DType, PhysicsSystem2D, Label, Enemy, PlayerBullet, _dec, _class, _crd, ccclass, property, Collider;
      ...
      _export("Collider", Collider = (_dec = ccclass('Collider'), _dec(_class = class Collider extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (selfCollider.tag == 0 && otherCollider.tag == 2 || selfCollider.tag == 2 && otherCollider.tag == 0 || selfCollider.tag == 0 && otherCollider.tag == 3 || selfCollider.tag == 3 && otherCollider.tag == 0) {
            alert("你以死亡，分数：" + this.dieNumber); // director.purgeDirector();
          }
        }
...
//# sourceMappingURL=f6abdc347e75e4a8ce3d38e03ba730e0decbfb9b.js.map