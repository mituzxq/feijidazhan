      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        ememybullet() {
          this.schedule(() => {
            ...
            var prefab = this.node.parent.getChildByName("Prefab");
            var player = prefab.getChildByName("enemy").position;
            buller.setPosition(player.x, player.y - 50, 0);
          }, 0.5);
        }
...
//# sourceMappingURL=099ff89576d842a1242eab3f41b62d36fa47671a.js.map