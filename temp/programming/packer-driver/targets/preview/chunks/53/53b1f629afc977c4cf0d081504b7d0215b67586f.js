System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Contact2DType, director, PhysicsSystem2D, Label, Enemy, EnemyBullet, Energy, PlayerBullet, _dec, _class, _crd, ccclass, dieNumber, Collider;
      ...
      _export("Collider", Collider = (_dec = ccclass('Collider'), _dec(_class = class Collider extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (selfCollider.tag == 0 && otherCollider.tag == 2 || selfCollider.tag == 2 && otherCollider.tag == 0 || selfCollider.tag == 0 && otherCollider.tag == 3 || selfCollider.tag == 3 && otherCollider.tag == 0) {
            alert("你以死亡，分数：" + dieNumber);
            director.purgeDirector();
          }
        }

        setScore() {
          this.node.children[0].getComponent(Label).string = "score:" + ++dieNumber;
          this.node.getComponent(_crd && Energy === void 0 ? (_reportPossibleCrUseOfEnergy({
            error: Error()
...
//# sourceMappingURL=53b1f629afc977c4cf0d081504b7d0215b67586f.js.map