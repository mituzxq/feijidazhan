  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        start() {
          this.bullet();
          this.ememy(); // PhysicsSystem2D.instance.on(Contact2DType.BEGIN_CONTACT, this.onBeginContact, this);
        }
        ...
        ememy() {
          this.schedule(() => {
            var ememyX = Math.floor(Math.random() * 350) - 175;
...
//# sourceMappingURL=538f04dbac33d02666f31b22dc2476df8f4045b9.js.map