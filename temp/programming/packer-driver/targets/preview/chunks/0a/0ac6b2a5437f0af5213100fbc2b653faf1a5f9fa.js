  ...
  return {
    ...
    execute: function () {
      ...
      _export("BulletAudio", BulletAudio = (_dec = ccclass('BulletAudio'), _dec(_class = class BulletAudio extends Component {
        start() {
          var player = this.getComponent(AudioSource); // loader.loadRes('audio/bullet', function (err, prefab) { }
...
//# sourceMappingURL=0ac6b2a5437f0af5213100fbc2b653faf1a5f9fa.js.map