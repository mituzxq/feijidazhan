    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property({
        ...
        die() {
          ...
          die.setPosition(this.node.position); // this.node.parent.getChildByName("enemydie").getComponent(Enemydie).die();
...
//# sourceMappingURL=665f562fceab003fecc0b8a500a0fd323a1a9c22.js.map