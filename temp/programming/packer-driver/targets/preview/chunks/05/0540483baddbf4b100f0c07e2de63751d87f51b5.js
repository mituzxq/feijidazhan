System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Contact2DType, instantiate, PhysicsSystem2D, Prefab, Label, director, Bullet, enemyManger, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GameManger;
  ...
  function _reportPossibleCrUseOfenemyManger(extras) {
    _reporterNs.report("enemyManger", "./enemyManger", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      enemyManger = _unresolved_3.enemyManger;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        start() {
          this.schedule(() => {
            ...
            var player = this.node.children[0].position;
            buller.setPosition(player.x, player.y + 40, 0);
          }, 0.5);
          this.schedule(() => {
            var ememyX = Math.floor(Math.random() * 160) - 80;
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          if (selfCollider.tag == 0 && otherCollider.tag == 1 || selfCollider.tag == 1 && otherCollider.tag == 0) {
            if (selfCollider.tag == 0) {
              ...
              otherCollider.getComponent(_crd && enemyManger === void 0 ? (_reportPossibleCrUseOfenemyManger({
                error: Error()
              }), enemyManger) : enemyManger).die();
            }

            if (selfCollider.tag == 1) {
              selfCollider.getComponent(_crd && enemyManger === void 0 ? (_reportPossibleCrUseOfenemyManger({
                error: Error()
              }), enemyManger) : enemyManger).die();
        ...
        score() {
          var t = this.dieNumber++;
          this.printScore();
        }

        printScore() {
          var score = this.node.children[1];
...
//# sourceMappingURL=0540483baddbf4b100f0c07e2de63751d87f51b5.js.map