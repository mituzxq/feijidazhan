      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        ememy() {
          this.schedule(() => {
            ...
            var enemypos = enemy.position; // this.schedule(() => {
        ...
        enemybullet() {
          this.schedule(() => {
            ...
            buller.setParent(this.node.parent);
            var position = this.node.parent.getChildByName("enemy0").position;
...
//# sourceMappingURL=0584d11b1488528816ff2d20e0267d3941aed853.js.map