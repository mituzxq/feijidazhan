System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Contact2DType, PhysicsSystem2D, Label, Enemy, EnemyBullet, Energy, PlayerBullet, _dec, _class, _crd, ccclass, Collider;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Collider", Collider = (_dec = ccclass('Collider'), _dec(_class = class Collider extends Component {
        ...
        setScore() {
          if (this.dieNumber % 10 == 0) {// this.node.getComponent(GameManger).randoms();
          }
...
//# sourceMappingURL=167ba1552bdb8e4130b13a1bcd876fca11a674f8.js.map