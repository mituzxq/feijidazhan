    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property({
        ...
        die() {
          ...
          this.node.destroy();
          var dies = this.node.parent.getChildByName("enemydie").getComponent(_crd && Enemydie === void 0 ? (_reportPossibleCrUseOfEnemydie({
            error: Error()
          }), Enemydie) : Enemydie);
          this.scheduleOnce(function () {
            this.node.parent.getChildByName("enemydie").getComponent(_crd && Enemydie === void 0 ? (_reportPossibleCrUseOfEnemydie({
              error: Error()
            }), Enemydie) : Enemydie).destroy();
          }, 0.3);
        }
...
//# sourceMappingURL=9d2ea4e876f268829eb989b9ffdbf8ef745e88b4.js.map