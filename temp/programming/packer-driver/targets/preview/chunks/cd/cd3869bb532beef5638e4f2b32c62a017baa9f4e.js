      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        ememybullet() {
          this.schedule(() => {
            ...
            var Enemyall = new (_crd && EnemyAll === void 0 ? (_reportPossibleCrUseOfEnemyAll({
              error: Error()
            }), EnemyAll) : EnemyAll)();
            var enemy = Enemyall.node.getChildByName("enemy").position;
...
//# sourceMappingURL=cd3869bb532beef5638e4f2b32c62a017baa9f4e.js.map