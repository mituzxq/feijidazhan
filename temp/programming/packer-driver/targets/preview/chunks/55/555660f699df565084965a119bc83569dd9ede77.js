      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        Bullets() {
          this.schedule(() => {
            ...
            var hero = new (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              error: Error()
            }), Player) : Player)().node;
            buller.parent = hero; // let player = this.getComponent(Player).node.position;
            // let play = new Player();
            // let player = play.node.position;
...
//# sourceMappingURL=555660f699df565084965a119bc83569dd9ede77.js.map