      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        Bullets() {
          this.schedule(() => {
            ...
            let play = new (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              error: Error()
            }), Player) : Player)();
            let player = play.node.position; // let player = this.node.parent.position;
...
//# sourceMappingURL=8c6a0e9103a4a6bf799fca697c036cae0e8671ea.js.map