  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        Bullets() {
          this.schedule(() => {
            let buller = instantiate(this.bullerPre); // let player = this.getComponent(Player).node.position;
            // let play = new Player();
...
//# sourceMappingURL=6ad37b3f25d091d11c0faec3a8a3f28cab5e9b94.js.map