System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Prefab, Energy, Collider, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GameManger;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Collider = _unresolved_3.Collider;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        random() {
          ...
          if (this.dieNumber % 10 == 0) {
            randoms = this.node.getChildByName("energy").getComponent(_crd && Energy === void 0 ? (_reportPossibleCrUseOfEnergy({
              error: Error()
...
//# sourceMappingURL=625d7518d80659c474cfd15e1967e1794aecd440.js.map