      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        Bullets() {
          this.schedule(() => {
            ...
            let player = this.getComponent(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              error: Error()
            }), Player) : Player).node.position; // let play = new Player();
...
//# sourceMappingURL=3ca25b7b4be5e47a16f1d474bbdc7140f138cc34.js.map