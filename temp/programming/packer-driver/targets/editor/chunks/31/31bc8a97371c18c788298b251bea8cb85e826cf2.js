      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        ememybullet() {
          this.schedule(() => {
            let buller = instantiate(this.playerbullerPre);
            buller.setParent(this.node.parent);
            console.log(this.node.parent.getChildByName("enemy").name);
            let ememy = this.node.parent.getChildByName("enemy").position;
            buller.setPosition(ememy.x, ememy.y - 50, 0);
          }, 0.5);
        }
...
//# sourceMappingURL=31bc8a97371c18c788298b251bea8cb85e826cf2.js.map