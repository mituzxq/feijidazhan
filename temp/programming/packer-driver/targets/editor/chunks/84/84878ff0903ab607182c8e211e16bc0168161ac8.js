    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property({
        ...
        die() {
          ...
          console.log(play.playOnAwake);
          console.log(play.loop);
          console.log(play.duration);
          console.log(play.currentTime);
          console.log(play.clip); // resources.load("img/enemydie.png", SpriteFrame, (err, res) => {
          //     if (err) {
          //         console.log(err);
          //     }
...
//# sourceMappingURL=84878ff0903ab607182c8e211e16bc0168161ac8.js.map