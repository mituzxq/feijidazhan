      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        playerbullet3() {
          this.schedule(() => {
            ...
            buller.setParent(this.node.parent);
            buller2.setParent(this.node.parent);
            let player = this.node.parent.getChildByName("hero").position; // buller.setPosition(player.x, player.y + 50, 0);
...
//# sourceMappingURL=fe7503da7873de2620c08a01828f2269e32d61cd.js.map