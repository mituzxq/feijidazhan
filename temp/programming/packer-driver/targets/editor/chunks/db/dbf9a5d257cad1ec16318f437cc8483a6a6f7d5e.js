    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property({
        ...
        die() {
          ...
          this.node.destroy();
          let dies = this.node.parent.getChildByName("enemydie").getComponent(_crd && Enemydie === void 0 ? (_reportPossibleCrUseOfEnemydie({
            error: Error()
          }), Enemydie) : Enemydie);
...
//# sourceMappingURL=dbf9a5d257cad1ec16318f437cc8483a6a6f7d5e.js.map