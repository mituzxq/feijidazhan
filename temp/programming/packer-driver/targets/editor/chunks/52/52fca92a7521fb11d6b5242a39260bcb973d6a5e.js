System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, instantiate, Prefab, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, Enemy;
    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          if (bulletY < -550) {
            this.die();
            this.node.parent.getChildByName("enemybullet").destroy();
          }
        }
...
//# sourceMappingURL=52fca92a7521fb11d6b5242a39260bcb973d6a5e.js.map