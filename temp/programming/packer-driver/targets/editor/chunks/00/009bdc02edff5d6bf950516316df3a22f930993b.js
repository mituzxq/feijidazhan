  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        //         let EnemyAll = this.node.parent.getChildByName("EnemyAll");
        //         let enemys = EnemyAll.getChildByName("enemy");
        //         let enemy = enemys.position;
        ...
        ememy() {
          this.schedule(() => {
            ...
            //     let buller = instantiate(this.playerbullerPre);
            //     buller.setParent(this.node.parent.getChildByName("EnemyAll"));
            //     buller.setPosition(enemypos.x, enemypos.y - 50, 0);
            // }, 0.5)
          }, 1);
        }
...
//# sourceMappingURL=009bdc02edff5d6bf950516316df3a22f930993b.js.map