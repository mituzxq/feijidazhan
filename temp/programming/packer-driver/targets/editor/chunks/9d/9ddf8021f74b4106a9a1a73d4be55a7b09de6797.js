  ...
  return {
    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property({
        ...
        static playMusic() {
          const audioSource = Enemy._audioSource;
        ...
        static playSound(name) {
          ...
          let cachedAudioClip = Enemy._cachedAudioClipMap[path];
...
//# sourceMappingURL=9ddf8021f74b4106a9a1a73d4be55a7b09de6797.js.map