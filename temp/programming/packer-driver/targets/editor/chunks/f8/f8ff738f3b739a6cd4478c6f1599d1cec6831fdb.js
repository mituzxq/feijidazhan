    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property({
        ...
        die() {
          ...
          this.diepre();
          this.node.destroy();
          this.node.children[0].getComponent(_crd && Enemydie === void 0 ? (_reportPossibleCrUseOfEnemydie({
            error: Error()
...
//# sourceMappingURL=f8ff738f3b739a6cd4478c6f1599d1cec6831fdb.js.map