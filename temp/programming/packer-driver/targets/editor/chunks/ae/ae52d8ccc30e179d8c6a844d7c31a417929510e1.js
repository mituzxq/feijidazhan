System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Contact2DType, PhysicsSystem2D, Label, director, BoxCollider2D, Enemy, Enemy1, EnemyBullet, Energy, GameManger, Missile, PlayerBullet, _dec, _class, _crd, ccclass, Collider;
    ...
    execute: function () {
      ...
      _export("Collider", Collider = (_dec = ccclass('Collider'), _dec(_class = class Collider extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          if (selfCollider.tag == 0 && otherCollider.tag == 2 || selfCollider.tag == 2 && otherCollider.tag == 0 || selfCollider.tag == 0 && otherCollider.tag == 3 || selfCollider.tag == 3 && otherCollider.tag == 0 || selfCollider.tag == 0 && otherCollider.tag == 6 || selfCollider.tag == 6 && otherCollider.tag == 0) {
...
//# sourceMappingURL=ae52d8ccc30e179d8c6a844d7c31a417929510e1.js.map