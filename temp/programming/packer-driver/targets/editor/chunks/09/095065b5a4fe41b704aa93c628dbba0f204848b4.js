      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        ememybullet() {
          this.schedule(() => {
            ...
            buller.setParent(this.node.parent);
            console.log(this.node.name + '\n' + this.node.parent.name);
            let prefab = this.node.parent.getChildByName("Prefab");
            let player = prefab.getChildByName("enemy").position;
            buller.setPosition(player.x, player.y - 50, 0);
          }, 0.5);
        }
...
//# sourceMappingURL=095065b5a4fe41b704aa93c628dbba0f204848b4.js.map