      ...
      _export("Collider", Collider = (_dec = ccclass('Collider'), _dec(_class = class Collider extends Component {
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          if (selfCollider.tag == 1 && otherCollider.tag == 2 || selfCollider.tag == 2 && otherCollider.tag == 1) {
            ...
            let Score = this.node.parent;
            let score = Score.getComponent(_crd && GameManger === void 0 ? (_reportPossibleCrUseOfGameManger({
              error: Error()
...
//# sourceMappingURL=6dab0aed2d3555b976b35d97f24026a108445bbc.js.map