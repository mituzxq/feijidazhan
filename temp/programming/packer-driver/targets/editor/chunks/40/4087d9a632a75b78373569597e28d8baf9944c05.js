    ...
    execute: function () {
      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        constructor(...args) {
          ...
          this.number = this.node.children[0].getComponent(_crd && Collider === void 0 ? (_reportPossibleCrUseOfCollider({
            error: Error()
          }), Collider) : Collider);
        }
...
//# sourceMappingURL=4087d9a632a75b78373569597e28d8baf9944c05.js.map