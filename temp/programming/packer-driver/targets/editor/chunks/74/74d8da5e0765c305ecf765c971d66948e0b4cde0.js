      ...
      _export("GameManger", GameManger = (_dec = ccclass('GameManger'), _dec2 = property({
        ...
        ememy() {
          this.schedule(() => {
            ...
            let enemypos = enemy.position; // this.schedule(() => {
        ...
        enemybullet() {
          this.schedule(() => {
            let buller = instantiate(this.enemybullerPre);
            buller.setParent(this.node.parent);
            let position = this.node.parent.getChildByName("enemy0").position;
...
//# sourceMappingURL=74d8da5e0765c305ecf765c971d66948e0b4cde0.js.map