System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Contact2DType, instantiate, PhysicsSystem2D, Prefab, director, PlayerBullet, Enemy, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, GameManger;
        ...
        ememy() {
          this.schedule(() => {
            ...
            this.schedule(() => {
              ...
              buller.setParent(this.node.parent.getChildByPath("EnemyAll"));
          ...
          if (selfCollider.tag == 1 && otherCollider.tag == 2 || selfCollider.tag == 2 && otherCollider.tag == 1) {
            if (selfCollider.tag == 1) {
              ...
              otherCollider.getComponent(_crd && Enemy === void 0 ? (_reportPossibleCrUseOfEnemy({
                error: Error()
              }), Enemy) : Enemy).die(); // this.node.parent.getChildByName("EnemyAll").getChildByName("enemybullet").getComponent(EnemyBullet).die();
            }
            ...
            if (selfCollider.tag == 2) {
              ...
              otherCollider.getComponent(_crd && PlayerBullet === void 0 ? (_reportPossibleCrUseOfPlayerBullet({
                error: Error()
              }), PlayerBullet) : PlayerBullet).die(); // this.node.parent.getChildByName("EnemyAll").getChildByName("enemybullet").getComponent(EnemyBullet).die();
            }

            this.node.parent.getChildByPath("EnemyAll/enemy").destroy(); // this.score();
          }
...
//# sourceMappingURL=23a25a8c8fbae71f62554c255891ba0e5075bc2d.js.map