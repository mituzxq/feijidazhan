System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, instantiate, Prefab, resources, SpriteFrame, Sprite, loader, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, Enemy;
    ...
    execute: function () {
      ...
      _export("Enemy", Enemy = (_dec = ccclass('Enemy'), _dec2 = property({
        ...
        die() {
          ...
          loader.loadRes("img/enemydie.png", SpriteFrame, (err, res) => {
            this.node.getComponent(Sprite).spriteFrame = res;
          });
        }
...
//# sourceMappingURL=32be847bf3a3bd3b789c6a4812be4f7536da65db.js.map